<div class="flex flex-col p-4">
    ...
    <div class="bg-gray-100 dark:bg-gray-900 shadow-lg rounded-lg p-6 mb-2">
        <h3 class="text-xl font-semibold mb-4 text-gray-800 dark:text-gray-200">ID Information</h3>
        <p class="text-gray-700 dark:text-gray-300"><strong>ID Type:</strong> {{ $visitor->id_name }} </p>
        <div class="text-gray-700 dark:text-gray-300">
            <strong>ID Document:</strong>
            <div class="mt-2">
            <img src="{{ Storage::url($visitor->id_document_path) }}" alt="ID Document" class="max-w-full h-auto rounded-lg shadow-md">
            </div>
        </div>
    </div>
    <div class="bg-gray-100 dark:bg-gray-900 shadow-lg rounded-lg p-6 mb-2">
