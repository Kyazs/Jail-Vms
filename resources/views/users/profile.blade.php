<x-layout>
        <div class="flex flex-col p-4">
            ...
            <div class="bg-gray-100 dark:bg-gray-900 shadow-lg rounded-lg p-6 mb-2">
                ...
                <p class="text-gray-700 dark:text-gray-300"><strong>First Name:</strong> John Casper</p>
                <p class="text-gray-700 dark:text-gray-300"><strong>Last Name:</strong> Santos</p>
                <p class="text-gray-700 dark:text-gray-300"><strong>Middle Name:</strong> G.</p>
                <p class="text-gray-700 dark:text-gray-300"><strong>Contact Number:</strong> 09123456789</p>
                <p class="text-gray-700 dark:text-gray-300"><strong>Birthdate:</strong> 01/01/2000</p>
                <p class="text-gray-700 dark:text-gray-300"><strong>Email:</strong> john.casper@gmail.com</p>
                <p class="text-gray-700 dark:text-gray-300"><strong>Gender:</strong> Male</p>
            </div>
            <div class="bg-gray-100 dark:bg-gray-900 shadow-lg rounded-lg p-6 mb-2">
